...
class ForgetPassPage extends StatelessWidget {
  ...
  final Select_email _select_email = Get.put(Select_email());
  @override
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        backgroundColor: BACKGOUND_COLOR,
        body: GetBuilder<Select_email>(builder: (controller) {
          return controller.isSending
              ...
              : Padding(
                  ...
                  child: Form(
                    ...
                    key: _select_email.reset_global_key,
                    child: ListView(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            GetBuilder<Select_email>(
                                init: Select_email(),
                                builder: (Select_email controller) {
                                  return TextFormFieldWidgets(
                                    controller:
                                        controller.email_reset_controller,
                                    validator: (value) {
